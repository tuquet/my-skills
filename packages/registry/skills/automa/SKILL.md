...
- **Viết JSON workflow chuẩn:** Hướng dẫn chi tiết cấu trúc JSON, nội suy biến, và các mẫu workflow hoàn chỉnh tại [references/workflow_json_guide.md](./references/workflow_json_guide.md).
- **Tìm DOM selector / XPath:** Hướng dẫn inspect, ưu tiên XPath, kiểm tra và báo lỗi tại [references/dom_selector_guide.md](./references/dom_selector_guide.md).
